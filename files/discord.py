...
def gradient_text(text, start_color = "00FF00", end_color = "00FF00") -> str:
...
async def download_stickers_async(stickers, inner_sticker_dir) -> str:
    ...
    async with aiohttp.ClientSession() as session:
        ...
        successful_downloads = sum(results)
        return successful_downloads
system("title " + "Discord Tool Kit - By Frnaxx -  CTRL + C at any time to stop")
...
while True:
    try:
        ...
        mode = input(gradient_text(rf"""      
                   ...
                   __| _/|__| ______ ____  ___________  __| _/ _/  |_  ____   ____ |  |   |  | _|__|/  |_ 
                  / __ | |  |/  ___// ___\/  _ \_  __ \/ __ |  \   __\/  _ \ /  _ \|  |   |  |/ /  \   __\
                 / /_/ | |  |\___ \\  \__(  <_> )  | \/ /_/ |   |  | (  <_> |  <_> )  |__ |    <|  ||  |  
                 \____ | |__/____  >\___  >____/|__|  \____ |   |__|  \____/ \____/|____/ |__|_ \__||__|  
                      \/         \/     \/                 \/                                  \/         
